-- Presence mode: only explicit segment-coupon bindings; disable min/max ratio fallback.
...
BEGIN
  ...
  IF FOUND THEN
    ...
    IF NOT public.fc_customer_uses_presence_segment_mode(v_customer_id) THEN
