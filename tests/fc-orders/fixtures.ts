...
export const FULFILLMENT_STAGE_CASES: ReadonlyArray<{
  ...
  { status: "payment_pending", stage: "payment_confirmed" },
  { status: "order_confirmed", stage: "design_locked" },
  { status: "awaiting_brand_inputs", stage: "design_locked" },
  { status: "design_in_progress", stage: "design_locked" },
  { status: "awaiting_design_approval", stage: "design_locked" },
  { status: "design_approved", stage: "final_sample_approval" },
  { status: "production", stage: "mass_production" },
  { status: "quality_check", stage: "mass_production" },
  { status: "ready_to_ship", stage: "mass_production" },
  { status: "shipped", stage: "bulk_shipment" },
  { status: "delivered", stage: "completed" },
  { status: "distribution_planning", stage: "completed" },
  { status: "distributing", stage: "completed" },
